...
{
    ::uavcan::DataTypeSignature signature(0xB4CD52A3B79CA8F5ULL);
...
void YamlStreamer< ::uavcan::olliw::storm32::Control >::stream(Stream& s, ::uavcan::olliw::storm32::Control::ParameterType obj, const int level)
{
    ...
    s << "frame: ";
    YamlStreamer< ::uavcan::olliw::storm32::Control::FieldTypes::frame >::stream(s, obj.frame, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    YamlStreamer< ::uavcan::olliw::storm32::Control::FieldTypes::anglequaternion_tag >::stream(s, obj.anglequaternion_tag, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
